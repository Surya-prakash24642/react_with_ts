...
const CreateNew: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <form onSubmit={handleSubmit} className="max-w-lg mx-auto bg-white p-8 border border-gray-300 rounded shadow">
        <div>
        ...
        <button type="submit" className="mt-4 px-4 py-3 bg-blue-600 text-white rounded hover:bg-blue-700">
          Submit
        </button>
      </form>
    </div>
